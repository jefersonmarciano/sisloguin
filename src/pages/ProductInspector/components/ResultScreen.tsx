...
const ResultScreen: React.FC<ResultScreenProps> = ({ results, onContinue }) => {
  ...
  return (
    <div className="p-6 flex flex-col items-center">
      <div className={`bg-green-900 rounded-full w-16 h-16 flex items-center justify-center mb-4`}>
      ...
      <div className="bg-gradient-to-r from-temu-orange/10 to-amber-500/10 p-4 rounded-lg w-full max-w-xs mb-6 border border-gray-700">
        <div className="flex justify-between items-center">
          <span className="text-gray-300">{t('youEarned')}:</span>
